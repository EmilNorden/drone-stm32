...
int main(void)
{
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	  ...
	  HAL_Delay(250);
	  ssd1351_fillrect(&screen, 0, 0, 64, 64, BLUE);
	  HAL_Delay(250);*/
  }
  /* USER CODE END 3 */
}
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, LD1_Pin|Oled_RES_Pin|Oled_DC_Pin|LD3_Pin
  ...
  /*Configure GPIO pins : LD1_Pin Oled_RES_Pin Oled_DC_Pin LD3_Pin
                           LD2_Pin */
  GPIO_InitStruct.Pin = LD1_Pin|Oled_RES_Pin|Oled_DC_Pin|LD3_Pin
                          |LD2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void StartDisplayTask(void *argument)
{
  /* USER CODE BEGIN StartDisplayTask */
	run_display_task(&hspi1, argument);
  /* Infinite loop */
  for(;;)
  {
    osDelay(1);
